...
class Creature : virtual public Thing
{
	...
	public:
		...
		//WALKFIELD
		virtual bool getWalkableField(CombatType_t type) const;
		virtual uint32_t IsWalkableField() const {
			return false;
		}
		...
		void gainMana(Creature* attacker, int32_t manaGain);
		...
		// Flash-Client
		virtual void onAttackedCreatureDisappear(bool, const Creature*) {}
		virtual void onFollowCreatureDisappear(bool, const Creature*) {}
