...
bool IOBan::isPlayerAuction(uint32_t playerId, uint32_t accountId)
{
	std::ostringstream query;
	query << "SELECT 1 FROM `player_selling` WHERE `player_id` = " << playerId << " AND `player_account` = " << accountId;
