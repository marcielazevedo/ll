...
class ProtocolLogin : public Protocol
{
	...
	protected:
		...
		//int64_t timeTriedConnect;

		/*
		//TRY TO CONNECT
		uint8_t getConnectTriesExaust() const {
			return connectTriesExaustThreshold;
		}
		void resetConnectTriesExaust() {
			connectTriesExaustThreshold = 0;
		}
		void incrementConnectTriesExaust() {
			connectTriesExaustThreshold++;
		}
		uint8_t connectTriesExaustThreshold; //TRY TO CONNECT
		*/
};
