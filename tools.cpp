...
itemAttrTypes stringToItemAttribute(const std::string& str)
{
	...
	} else if (str == "criticalextradamage") {
		return ITEM_ATTRIBUTE_CRITICALEXTRADAMAGE;
	} else if (str == "lifeleechchance") {
		return ITEM_ATTRIBUTE_LIFELEECHCHANCE;
	} else if (str == "lifeleechextradamage") {
		return ITEM_ATTRIBUTE_LIFELEECHEXTRADAMAGE;
	} else if (str == "manaleechchance") {
		return ITEM_ATTRIBUTE_MANALEECHCHANCE;
	} else if (str == "manaleechextradamage") {
		return ITEM_ATTRIBUTE_MANALEECHEXTRADAMAGE;
	} else if (str == "owner") {
...
const char* getReturnMessage(ReturnValue value)
{
	switch (value) {
		...
		case RETURNVALUE_CONTAINERISFULL:
			return "You cannot put a bag with a lot of weight in this tile.";
		...
		case RETURNVALUE_REWARDCONTAINEREMPTY:
			...
			//LOGINPROTECT
		case RETURNVALUE_YOUMAYNOTATTACKIMMEDIATELYAFTERLOGGINGIN:
			return "You can not attack immediately after login.";
