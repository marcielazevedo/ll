...
#ifndef FS_REWARDCHEST_H_C3EF10190329447883B9C3479234EE5C
#define FS_REWARDCHEST_H_C3EF10190329447883B9C3479234EE5C
...
class RewardChest final : public Container
{
	public:
		...
		void setParentRewardChest(RewardChest* rewardChest) {
			this->rewardChest = rewardChest;
		}

		RewardChest* getParentRewardChest() const {
			return rewardChest;
		}
