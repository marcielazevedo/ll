...
enum itemAttrTypes : uint32_t {
	...
	ITEM_ATTRIBUTE_CRITICALEXTRADAMAGE = 1 << 24,
	ITEM_ATTRIBUTE_LIFELEECHCHANCE = 1 << 25,
	ITEM_ATTRIBUTE_LIFELEECHEXTRADAMAGE = 1 << 26,
	ITEM_ATTRIBUTE_MANALEECHCHANCE = 1 << 27,
	ITEM_ATTRIBUTE_MANALEECHEXTRADAMAGE = 1 << 28,
};
...
enum ReturnValue {
	...
	RETURNVALUE_YOUMAYNOTATTACKIMMEDIATELYAFTERLOGGINGIN,
	...
	RETURNVALUE_REWARDCONTAINEREMPTY,
};
