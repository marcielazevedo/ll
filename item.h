...
enum AttrTypes_t {
	...
	ATTR_CRITICALEXTRADAMAGE = 35,
	ATTR_LIFELEECHCHANCE = 36,
	ATTR_LIFELEECHEXTRADAMAGE = 37,
	ATTR_MANALEECHCHANCE = 38,
	ATTR_MANALEECHEXTRADAMAGE = 39,
};
...
class Item : virtual public Thing
{
	public:
		...
		int8_t getCriticalHitChance() const {
		...
		int8_t getCriticalExtraDamage() const {
			if (hasAttribute(ITEM_ATTRIBUTE_CRITICALEXTRADAMAGE)) {
				return getIntAttr(ITEM_ATTRIBUTE_CRITICALEXTRADAMAGE);
			}
			return items[id].criticalExtraDamage;
		}

		int8_t getLifeLeechChance() const {
			if (hasAttribute(ITEM_ATTRIBUTE_LIFELEECHCHANCE)) {
				return getIntAttr(ITEM_ATTRIBUTE_LIFELEECHCHANCE);
			}
			return items[id].lifeLeechChance;
		}

		int8_t getLifeLeechExtraDamage() const {
			if (hasAttribute(ITEM_ATTRIBUTE_LIFELEECHEXTRADAMAGE)) {
				return getIntAttr(ITEM_ATTRIBUTE_LIFELEECHEXTRADAMAGE);
			}
			return items[id].lifeLeechExtraDamage;
		}

		int8_t getManaLeechChance() const {
			if (hasAttribute(ITEM_ATTRIBUTE_MANALEECHCHANCE)) {
				return getIntAttr(ITEM_ATTRIBUTE_MANALEECHCHANCE);
			}
			return items[id].manaLeechChance;
		}

		int8_t getManaLeechExtraDamage() const {
			if (hasAttribute(ITEM_ATTRIBUTE_MANALEECHEXTRADAMAGE)) {
				return getIntAttr(ITEM_ATTRIBUTE_MANALEECHEXTRADAMAGE);
			}
			return items[id].manaLeechExtraDamage;
		}
