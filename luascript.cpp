...
void LuaScriptInterface::registerFunctions()
{
	...
	registerEnum(CONST_ME_RAGIAZCOCOON)
	registerEnum(CONST_ME_CRITICALHIT)
	...
	registerEnum(ITEM_ATTRIBUTE_CRITICALEXTRADAMAGE)
	registerEnum(ITEM_ATTRIBUTE_LIFELEECHCHANCE)
	registerEnum(ITEM_ATTRIBUTE_LIFELEECHEXTRADAMAGE)
	registerEnum(ITEM_ATTRIBUTE_MANALEECHCHANCE)
	registerEnum(ITEM_ATTRIBUTE_MANALEECHEXTRADAMAGE)
	...
	registerEnum(RETURNVALUE_CONTAINERISFULL)
	...
	registerEnum(RETURNVALUE_YOUMAYNOTATTACKIMMEDIATELYAFTERLOGGINGIN)
	registerEnum(RETURNVALUE_REWARDCONTAINEREMPTY)
	...
	registerEnumIn("configKeys", ConfigManager::SPAWN_STAGES)
	...
	registerMethod("Player", "getRewardChest", LuaScriptInterface::luaPlayerGetRewardChest); //MYREWARD
	registerMethod("Player", "getHouseInbox", LuaScriptInterface::luaPlayerGetHouseInbox); //HOUSEINBOX
	...
	registerMethod("Player", "sendCriticalMessage", LuaScriptInterface::luaPlayerSendCriticalMessage);
	registerMethod("Player", "removeMcFromEvent", LuaScriptInterface::luaPlayerRemoveMcFromEvent);

	registerMethod("Player", "sendWtfStorage", LuaScriptInterface::luaPlayerSendWtfStorage);
	...
	registerMethod("ItemType", "getCriticalExtraDamage", LuaScriptInterface::luaItemTypeGetCriticalExtraDamage);
	registerMethod("ItemType", "getLifeLeechChance", LuaScriptInterface::luaItemTypeGetLifeLeechChance);
	registerMethod("ItemType", "getLifeLeechExtraDamage", LuaScriptInterface::luaItemTypeGetLifeLeechExtraDamage);
	registerMethod("ItemType", "getManaLeechChance", LuaScriptInterface::luaItemTypeGetManaLeechChance);
	registerMethod("ItemType", "getManaLeechExtraDamage", LuaScriptInterface::luaItemTypeGetManaLeechExtraDamage);
...
int LuaScriptInterface::luaCreatureAddMana(lua_State* L)
{
	...
	if (!animationOnLoss && manaChange < 0) {
		...
		g_game.combatChangeMana(nullptr, creature, manaChange, ORIGIN_NONE, damage);
	}
	pushBoolean(L, true);
	return 1;
}
...
//HOUSEINBOX
int LuaScriptInterface::luaPlayerGetHouseInbox(lua_State* L)
{
	// player:getHouseInbox()
	Player* player = getUserdata<Player>(L, 1);
	if (!player) {
		lua_pushnil(L);
		return 1;
	...
	HouseInbox* houseInbox = player->getHouseInbox();
	if (houseInbox) {
		pushUserdata<Item>(L, houseInbox);
		setItemMetatable(L, -1, houseInbox);
	}
	else {
		pushBoolean(L, false);
	}
...
int LuaScriptInterface::luaPlayerGetRewardChest(lua_State* L) //MYREWARD
{
	...
	RewardChest* reward = player->getRewardChest();
	if (reward) {
...
int LuaScriptInterface::luaPlayerRemoveMcFromEvent(lua_State* L)
{
	// player:removeMcFromEvent()
	Player* player = getUserdata<Player>(L, 1);
	if (!player) {
		lua_pushnil(L);
		return 1;
	...
	lua_pushboolean(L, player->removeMcFromEvent = true);
	return 1;
}

int LuaScriptInterface::luaPlayerSendCriticalMessage(lua_State* L)
{
	// player:sendCriticalMessage()
	Player* player = getUserdata<Player>(L, 1);
	if (!player) {
		lua_pushnil(L);
		return 1;
	...
	lua_pushboolean(L, player->sendCriticalMessage = true);
	return 1;
}

int LuaScriptInterface::luaPlayerSendWtfStorage(lua_State* L)
{
	// player:sendendWtfStorage()
	Player* player = getUserdata<Player>(L, 1);
	if (!player) {
		lua_pushnil(L);
		return 1;
	...
	lua_pushboolean(L, player->sendWtfStorage = true);
	return 1;
}
...
int LuaScriptInterface::luaItemTypeGetCriticalExtraDamage(lua_State* L)
{
	// itemType:getCriticalExtraDamage()
	const ItemType* itemType = getUserdata<const ItemType>(L, 1);
	if (itemType) {
		lua_pushnumber(L, itemType->criticalExtraDamage);
	}
	else {
		lua_pushnil(L);
	}
...
int LuaScriptInterface::luaItemTypeGetLifeLeechChance(lua_State* L)
{
	// itemType:getLifeLeechChance()
	const ItemType* itemType = getUserdata<const ItemType>(L, 1);
	if (itemType) {
		lua_pushnumber(L, itemType->lifeLeechChance);
	}
	else {
		lua_pushnil(L);
	}
...
int LuaScriptInterface::luaItemTypeGetLifeLeechExtraDamage(lua_State* L)
{
	// itemType:getLifeLeechExtraDamage()
	const ItemType* itemType = getUserdata<const ItemType>(L, 1);
	if (itemType) {
		lua_pushnumber(L, itemType->lifeLeechExtraDamage);
	}
	else {
		lua_pushnil(L);
	}
...
int LuaScriptInterface::luaItemTypeGetManaLeechChance(lua_State* L)
{
	// itemType:getManaLeechChance()
	const ItemType* itemType = getUserdata<const ItemType>(L, 1);
	if (itemType) {
		lua_pushnumber(L, itemType->manaLeechChance);
	}
	else {
		lua_pushnil(L);
	}
...
int LuaScriptInterface::luaItemTypeGetManaLeechExtraDamage(lua_State* L)
{
	// itemType:getManaLeechExtraDamage()
	const ItemType* itemType = getUserdata<const ItemType>(L, 1);
	if (itemType) {
		lua_pushnumber(L, itemType->manaLeechExtraDamage);
	}
	else {
		lua_pushnil(L);
	}
...
int LuaScriptInterface::luaMonsterTypeIsBoss(lua_State* L)
{
	...
	MonsterType* monsterType = getUserdata<MonsterType>(L, 1);
	if (monsterType) {
		pushBoolean(L, monsterType->isBoss);
	}
	else {
		lua_pushnil(L);
	}
