...
class StoreEntry {
	public:
		...
		StoreEntry(const std::string& _name, const StoreOfferState_t& _categoryState, const std::string& _description, const StringVec& _icons) {
			name = _name;
		...
		const StringVec& getIcons() const {
			return icons;
		}
...
class StoreCategory : public StoreEntry {
	public:
		StoreCategory(const std::string& _name, const StoreOfferState_t& _categoryState, const std::string& _description, const StringVec& _icons) :
