...
class Game
{
	public:
		...
		bool combatChangeMana(Creature* attacker, Creature* target, int32_t manaChange, CombatOrigin origin, CombatDamage& damage);
		...
		void playerEquipItem(uint32_t playerId, uint16_t objectId); //EquipItem
