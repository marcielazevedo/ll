...
class ItemType
{
	public:
		...
		int32_t runeLevel;
		int32_t criticalHitChance, lifeLeechChance, manaLeechChance;
		...
		uint8_t lightColor;
		uint8_t shootRange;
		int8_t hitChance, criticalExtraDamage, lifeLeechExtraDamage, manaLeechExtraDamage;
