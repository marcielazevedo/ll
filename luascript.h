...
class LuaScriptInterface
{
	...
	protected:
		...
		//HOUSEINBOX
		static int luaPlayerGetHouseInbox(lua_State* L);
		...
		static int luaPlayerSendCriticalMessage(lua_State* L);
		static int luaPlayerRemoveMcFromEvent(lua_State* L);

		static int luaPlayerSendWtfStorage(lua_State* L);
		...
		static int luaItemTypeGetCriticalExtraDamage(lua_State* L);
		static int luaItemTypeGetLifeLeechChance(lua_State* L);
		static int luaItemTypeGetLifeLeechExtraDamage(lua_State* L);
		static int luaItemTypeGetManaLeechChance(lua_State* L);
		static int luaItemTypeGetManaLeechExtraDamage(lua_State* L);
		...
		static int luaMonsterTypeIsWalkableField(lua_State* L);
