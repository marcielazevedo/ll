...
std::list<uint16_t> Spells::getSpellsByVocation(uint16_t vocationId) //Flash Cliente
{
...
bool Spell::playerSpellCheck(Player* player) const
{
	...
	if (aggressive && player->checkLoginDelay()) {
		player->sendCancelMessage(RETURNVALUE_YOUMAYNOTATTACKIMMEDIATELYAFTERLOGGINGIN);
